      ...
      <footer className="site-footer">
        <div className="footer-inner">
          ...
          <div className="footer-brand">
            <div className="footer-logo">🛍️ <span>Ayaba Shop</span></div>
            <p className="footer-tagline">Shop smarter, live better. Fast delivery, great prices & exceptional support across Rwanda.</p>
            <div className="footer-socials">
              <a href="https://facebook.com/ayabashop" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="Facebook">
              ...
              <a href="https://instagram.com/ayabashop" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="Instagram">
              ...
              <a href="https://x.com/ayabashop" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="X">
                <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                X.com
              </a>
              <a href="https://wa.me/250781234567" target="_blank" rel="noopener noreferrer" className="social-btn social-btn-wa" aria-label="WhatsApp">
          ...
          <div className="footer-nav-group">
            <h4>Services</h4>
            <ul>
              <li><button onClick={() => changePage('services')}>📦 Delivery</button></li>
              <li><button onClick={() => changePage('services')}>🏛️ Irembo</button></li>
              <li><button onClick={() => changePage('services')}>📱 MTN MoMo</button></li>
              <li><button onClick={() => changePage('services')}>💻 Web Dev</button></li>
              <li><button onClick={() => changePage('services')}>🎬 Video Editing</button></li>
            </ul>
          </div>
          ...
          <div className="footer-nav-group">
            ...
            <ul>
              ...
              <li><a href="tel:+250781234567">📞 +250 781 234 567</a></li>
              <li><a href="mailto:info@ayabashop.rw">✉️ info@ayabashop.rw</a></li>
              <li><a href="https://wa.me/250781234567" target="_blank" rel="noopener noreferrer">💬 Chat on WhatsApp</a></li>
            </ul>
          </div>
